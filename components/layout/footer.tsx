...
function FooterComponent() {
  ...
  const industries = [
    { name: "WMS for E-Commerce", link: "/wms-for-ecommerce" },
    { name: "WMS for 3PL", link: "/wms-for-3pl" },
    { name: "WMS for Retail", link: "/wms-for-retail" },
    { name: "WMS for Couriers", link: "/wms-for-couriers" },
    { name: "Blog", link: "/blog" },
    { name: "Resources", link: "/resources" },
  ];
  const locations = [
    { name: "WMS London", link: "/warehouse-management-london" },
    { name: "WMS Manchester", link: "/warehouse-management-manchester" },
    { name: "WMS Birmingham", link: "/warehouse-management-birmingham" },
    { name: "WMS Leeds", link: "/warehouse-management-leeds" },
    { name: "Compare WMS", link: "/compare" },
  ...
  return (
    <footer className="bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 text-gray-700 py-32 border-t border-gray-200">
      <div className="max-w-8xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-20">
          ...
          <div className="md:col-span-3">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md">
                <Image src="/images/omniwtmslogo.png" alt="OmniWTMS Logo" width={32} height={32} className="object-contain rounded" />
              </div>
              <span className="bg-gradient-to-r from-blue-700 via-purple-600 to-indigo-700 text-transparent bg-clip-text font-extrabold text-xl">OmniWTMS</span>
            </div>
            <p className="text-gray-600 text-base leading-relaxed mb-5 max-w-sm">
          ...
          {/* Industries column */}
          <div className="md:col-span-2">
            <h3 className="text-sm font-bold bg-gradient-to-r from-green-600 to-teal-600 text-transparent bg-clip-text uppercase tracking-widest mb-4">Industries</h3>
            <ul className="space-y-2.5">
              {industries.map((item, i) => (
                <li key={i}><Link href={item.link} className="text-gray-700 hover:text-teal-600 text-sm transition-colors font-medium">{item.name}</Link></li>
              ))}
            </ul>
          </div>
          ...
          {/* Locations column */}
          <div className="md:col-span-2">
            <h3 className="text-sm font-bold bg-gradient-to-r from-orange-600 to-red-600 text-transparent bg-clip-text uppercase tracking-widest mb-4">UK Locations</h3>
            <ul className="space-y-2.5">
              {locations.map((item, i) => (
                <li key={i}><Link href={item.link} className="text-gray-700 hover:text-orange-600 text-sm transition-colors font-medium">{item.name}</Link></li>
              ))}
            </ul>
          </div>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row justify-between items-center border-t border-gray-200 pt-8 gap-4">
