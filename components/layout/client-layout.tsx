...
export function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-50 via-white to-blue-50/40">
        ...
        >
          ...
          >
            ...
            <dl className="space-y-2">
              ...
              <div className="flex justify-between">
                <dt>
                  <kbd className="px-2 py-1 bg-muted rounded">Alt + P</kbd>
                </dt>
                <dd>Go to Products</dd>
              </div>
              <div className="flex justify-between">
                <dt>
                  <kbd className="px-2 py-1 bg-muted rounded">Alt + O</kbd>
                </dt>
                <dd>Go to Orders</dd>
              </div>
              <div className="flex justify-between">
