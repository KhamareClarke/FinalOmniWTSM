...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="py-32 bg-gray-50 border-b border-gray-200">
      <div className="max-w-8xl mx-auto px-4">
        <div className="text-center mb-20">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 via-purple-100 to-indigo-100 border border-blue-200/60 shadow-sm mb-6">
            <span className="text-xs font-semibold text-blue-700 tracking-wide uppercase">Common Questions</span>
          </span>
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Everything you need to know about OmniWTMS
          </p>
        </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              {faqs.slice(0, 6).map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`}>
                  <AccordionTrigger className="text-left text-base font-semibold text-gray-800 hover:text-blue-600 py-4">
                    {faq.question}
                  </AccordionTrigger>
