        ...
        <div id="demo-form" className="max-w-8xl mx-auto px-4">
          ...
          <div className="text-center mb-20">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 via-purple-100 to-indigo-100 border border-blue-200/60 shadow-sm mb-6">
              <span className="text-xs font-semibold text-blue-700 tracking-wide uppercase">Get Started Today</span>
            </span>
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Live in 48 hours with zero setup fees. Our UK team configures everything for your operation.
            </p>
          </div>
