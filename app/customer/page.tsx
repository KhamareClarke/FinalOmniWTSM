...
export default function CustomerDashboard() {
  ...
  const handleSaveInventory = async () => {
    ...
    const rowsToInsert = uploadRows.map((row) => {
      ...
      Object.keys(row).forEach((key) => {
        ...
        if (dbColumn) {
          // Only proceed if we found a matching column
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <CustomerSidebar />
      {/* Main content */}
      <main className="flex-1 min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
        {/* Header */}
        <header className="bg-white border-b border-[#3456FF]/10 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold bg-gradient-to-r from-[#3456FF] to-[#8763FF] bg-clip-text text-transparent">
                Dashboard Overview
              </h2>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#3456FF] to-[#8763FF] text-white flex items-center justify-center">
                {customer.name
                  ?.split(" ")
                  .map((n: string) => n[0])
                  .join("")}
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold mb-1 tracking-tight bg-gradient-to-r from-[#3456FF] to-[#8763FF] bg-clip-text text-transparent">
              Dashboard Overview
            </h1>
          </div>
          {/* Stats Cards */}
          ...
          <p className="text-gray-500 mb-6">
            Welcome to your customer portal. Manage your orders and inventory
            from one place.
          </p>
          {/* Action Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-blue-50 rounded-xl shadow p-6 flex flex-col items-center">
              ...
              <div className="text-xs text-gray-500 mb-4 text-center">
                Create a new order from your inventory
              </div>
            </div>
            <div className="bg-green-50 rounded-xl shadow p-6 flex flex-col items-center">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M9 17v-2a4 4 0 014-4h2a4 4 0 014 4v2M9 17v2a4 4 0 004 4h2a4 4 0 004-4v-2"
                />
              </svg>
            ...
            <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M4 12V8a2 2 0 012-2h12a2 2 0 012 2v4"
                />
              </svg>
              <div className="font-semibold mb-2">Upload Stock</div>
              <div className="text-xs text-gray-500 mb-4 text-center">
                Upload your inventory list via CSV
              </div>
            </div>
          </div>
          {/* Orders Tabs */}
