...
export default function SignUpPage() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen mt-32 flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-4">
        <Card className="w-full max-w-md bg-white/95 backdrop-blur-md border-0 shadow-2xl rounded-xl overflow-hidden">
          <div className="h-1 w-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600" />
          <CardHeader className="space-y-2">
            <CardTitle className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-blue-700 via-purple-600 to-indigo-700 bg-clip-text text-transparent">
              {userType === "client"
            ...
            {userType === "client" ? (
              <Form {...clientForm}>
                ...
                >
                        ...
                        <div className="relative">
                          ...
                          <FormControl>
                            <Input
                              ...
                              className="pl-10 bg-gray-50/80 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500/20 rounded-lg"
                              {...field}
                            />
                          </FormControl>
                        </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white font-bold py-2.5 px-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300"
                    disabled={isLoading}
                  >
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-sm text-center">
              ...
              <Link
                ...
                className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 font-semibold hover:underline"
              >
                Sign in
              </Link>
            </div>
