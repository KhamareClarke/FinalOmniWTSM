  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2 bg-gradient-to-r from-[#3456FF] to-[#8763FF] bg-clip-text text-transparent">
            <BarChart3 className="h-7 w-7 text-[#3456FF] shrink-0" />
            Advanced analytics
          </h1>
