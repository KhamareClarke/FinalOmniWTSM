...
const loc = getLocation("warehouse-management-manchester")!;
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": `Yes — Manchester Logistics Group is one of our most successful customers, saving £47,000 per month after implementing OmniWTMS across their 3 warehouses and 50-vehicle fleet in Greater Manchester.` }
      },
      {
        "@type": "Question",
        "name": `How quickly can OmniWTMS go live for a ${loc.city} logistics company?`,
        "acceptedAnswer": { "@type": "Answer", "text": `OmniWTMS goes live within 48 hours for Manchester businesses. We provide full data migration, carrier integrations, and on-site or remote training — all included.` }
      },
      {
        "@type": "Question",
        "name": `Is OmniWTMS suitable for 3PL operations in ${loc.city}?`,
        "acceptedAnswer": { "@type": "Answer", "text": `Absolutely. OmniWTMS is purpose-built for multi-client 3PL operations, which are common in Greater Manchester's logistics sector. Features include client-segregated inventory, white-label portals, and automated billing.` }
      }
    ]
  };
